...
Pod::Spec.new do |s|
    ...
    s.subspec 'Foundation' do |ss|
        ...
        ss.subspec 'NSIndexPath' do |sss|
            ...
            sss.public_header_files = 'Foundation/NSIndexPath/*.{h,m}'
        end
        ...
        ss.subspec 'NSTimer' do |sss|
            ...
            sss.public_header_files = 'Foundation/NSTimer/*.{h,m}'
        end
