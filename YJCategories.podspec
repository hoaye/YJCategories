...
Pod::Spec.new do |s|
    ...
    s.subspec 'Foundation' do |ss|
        ...
        ss.subspec 'NSFileManager' do |sss|
            ...
            sss.public_header_files = 'YJCategories/Foundation/NSFileManager/*.{h,m}'
        end

        # 11. NSTimer 配置模块
        ss.subspec 'NSTimer' do |sss|
            sss.source_files        = 'YJCategories/Foundation/NSTimer/*.{h,m}'
            sss.public_header_files = 'YJCategories/Foundation/NSTimer/*.{h,m}'
        end
