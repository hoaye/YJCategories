...
Pod::Spec.new do |s|
    ...
    s.public_header_files = 'YJCategoriesGather/YJCategories/*.{h}'
    ...
    s.subspec 'UIKit' do |ss|
        ...
        ss.subspec 'UIDevice' do |sss|
            ...
            sss.public_header_files = 'YJCategoriesGather/YJCategories/UIKit/UIDevice/*.{h}'
        end

        # 10. UINavigationController 配置模块
        ss.subspec 'UINavigationController' do |sss|
            sss.source_files        = 'YJCategoriesGather/YJCategories/UIKit/UINavigationController/*.{h,m}'
            sss.public_header_files = 'YJCategoriesGather/YJCategories/UIKit/UINavigationController/*.{h}'
        end

        # 11. UIControl 配置模块
        ss.subspec 'UIControl' do |sss|
            sss.source_files        = 'YJCategoriesGather/YJCategories/UIKit/UIControl/*.{h,m}'
            sss.public_header_files = 'YJCategoriesGather/YJCategories/UIKit/UIControl/*.{h}'
        end

        # 12. UIFont 配置模块
        ss.subspec 'UIFont' do |sss|
            sss.source_files        = 'YJCategoriesGather/YJCategories/UIKit/UIFont/*.{h,m}'
            sss.public_header_files = 'YJCategoriesGather/YJCategories/UIKit/UIFont/*.{h}'
        end

        # 13. UINavigationBar 配置模块
        ss.subspec 'UINavigationBar' do |sss|
            sss.source_files        = 'YJCategoriesGather/YJCategories/UIKit/UINavigationBar/*.{h,m}'
            sss.public_header_files = 'YJCategoriesGather/YJCategories/UIKit/UINavigationBar/*.{h}'
        end

        # 14. UIResponder 配置模块
        ss.subspec 'UIResponder' do |sss|
            sss.source_files        = 'YJCategoriesGather/YJCategories/UIKit/UIResponder/*.{h,m}'
            sss.public_header_files = 'YJCategoriesGather/YJCategories/UIKit/UIResponder/*.{h}'
        end

        # 15. UIBezierPath 配置模块
        ss.subspec 'UIBezierPath' do |sss|
            sss.source_files        = 'YJCategoriesGather/YJCategories/UIKit/UIBezierPath/*.{h,m}'
            sss.public_header_files = 'YJCategoriesGather/YJCategories/UIKit/UIBezierPath/*.{h}'
        end

        # 16. UIScrollView 配置模块
        ss.subspec 'UIScrollView' do |sss|
            sss.source_files        = 'YJCategoriesGather/YJCategories/UIKit/UIScrollView/*.{h,m}'
            sss.public_header_files = 'YJCategoriesGather/YJCategories/UIKit/UIScrollView/*.{h}'
        end
    end
    ...
    s.subspec 'Foundation' do |ss|
        ...
        ss.subspec 'NSNotificationCenter' do |sss|
            ...
            sss.public_header_files = 'YJCategoriesGather/YJCategories/Foundation/NSNotificationCenter/*.{h}'
        end

        # 8. NSURL 配置模块
        ss.subspec 'NSURL' do |sss|
            sss.source_files        = 'YJCategoriesGather/YJCategories/Foundation/NSURL/*.{h,m}'
            sss.public_header_files = 'YJCategoriesGather/YJCategories/Foundation/NSURL/*.{h}'
        end

        # 8. NSDate 配置模块
        ss.subspec 'NSDate' do |sss|
            sss.source_files        = 'YJCategoriesGather/YJCategories/Foundation/NSDate/*.{h,m}'
            sss.public_header_files = 'YJCategoriesGather/YJCategories/Foundation/NSDate/*.{h}'
        end
        ...
        ss.subspec 'NSDateFormatter' do |sss|
            ...
            sss.public_header_files = 'YJCategoriesGather/YJCategories/Foundation/NSDateFormatter/*.{h}'
        end
        ...
        ss.subspec 'NSFileManager' do |sss|
            ...
            sss.public_header_files = 'YJCategoriesGather/YJCategories/Foundation/NSFileManager/*.{h}'
        end

        # 11. NSTimer 配置模块
        ss.subspec 'NSTimer' do |sss|
            sss.source_files        = 'YJCategoriesGather/YJCategories/Foundation/NSTimer/*.{h,m}'
            sss.public_header_files = 'YJCategoriesGather/YJCategories/Foundation/NSTimer/*.{h}'
        end
