...
- (void)yj_showToolbar:(BOOL)animated duration:(NSTimeInterval)duration completion:(YJFinishedBlock)completion{
    ...
    [self yj_setToolbarOriginY:viewHeight - toolbarHeight animated:animated duration:duration completion:completion];
}

- (void)yj_hideToolbar:(BOOL)animated duration:(NSTimeInterval)duration completion:(YJFinishedBlock)completion{
    CGSize viewSize = self.navigationController.view.frame.size;
    CGFloat viewHeight = [self isPortrait] ? viewSize.height : viewSize.width;
    [self yj_setToolbarOriginY:viewHeight animated:animated duration:duration completion:completion];
}
...
- (void)yj_moveToolbar:(CGFloat)deltaY animated:(BOOL)animated duration:(NSTimeInterval)duration completion:(YJFinishedBlock)completion{
    ...
    CGFloat nextY = frame.origin.y + deltaY;
    [self yj_setToolbarOriginY:nextY animated:animated duration:duration completion:completion];
}
